...
- [x] **BMI-01**: User stores height once in settings; BMI auto-calculated from weight entries
- [x] **BMI-02**: BMI is charted alongside weight in the weight view
...
| BMI-01 | Phase 2 | Complete |
| BMI-02 | Phase 2 | Complete |
