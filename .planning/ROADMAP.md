...
Plans:
- [ ] 01-01-PLAN.md — Walking Skeleton: install deps, Dexie schema, HashRouter, 3-tab layout, WeightForm, Dashboard, PWA manifest + service worker + update prompt
- [ ] 01-02-PLAN.md — Remaining 4 metric forms (sleep, steps, water, heart rate) + Settings (dark mode, height input)
...
|-------|----------------|--------|-----------|
| 1. Foundation & Core Logging | 0/3 | Not started | - |
